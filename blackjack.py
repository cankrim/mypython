...
def blackjack(name='Friend',new=True):
    ##Welcome
    graphic()
    print 
    print 'Welcome ' + (new==False)*'back ' + 'to Blackjack, {}.'.format(name)
    ...
    while cont.upper() != 'N':
        while True:
            ...
            ##Place Bet
            print 'Place your bet. It must be an integer between 1 and {}.'.format(chips)
    ...
    if chips == 0:
        sadgraphic()
        print "Sorry sucker. Better luck next time."
    elif chips < 100:
...
def rules():
    ...
    print "\nIn addition, you have three other moves that"
    ...
    print "immediately.\n"
    raw_input("Press 'Enter' to continue")
    print "\n3) Lastly, if you start with a pair of cards"
    ...
    print "a lower value.\n"
    raw_input("Press 'Enter' to continue")
    print "\n'Blackjack' is defined as and ace and a"
